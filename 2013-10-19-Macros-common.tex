...
\newcommand{\dmspawn}{\keyword{spawn\ }}
\newcommand{\equals}{=}
...
\newcommand{\SIAME}{\alg{SIAME}}
\newcommand{\SIAMESE}{\alg{SIAMESE}}
...
\newcommand{\diffSet}{X}
\newcommand{\numObjectBases}{N_{\mathrm{obj}}}
\newcommand{\numImageBases}{N_{\mathrm{img}}}
\newcommand{\numPerms}{N_{\mathrm{perms}}}
\newcommand{\permIndex}{r}
\newcommand{\permLength}{\ell}
...
%Added 8 July 2023 for DLfM submission
\newcommand{\mtmArray}{\mathcal{M}}
\newcommand{\dmstart}{i_{\mathrm{start}}}
\newcommand{\dmend}{i_{\mathrm{end}}}
\newcommand{\dmsynchronized}[1]{\keyword{synchronized}(#1)}
\newcommand{\hashValues}{H}
